...
public class Client implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            // Send the message to the server if connection is available
            if (dout != null) {
                dout.writeUTF(out);
            } else {
                System.out.println("DataOutputStream is not initialized!");
    ...
    // Format the message to display in the chat area
    public static JPanel formatLabel(String out) {
        JPanel panel = new JPanel();
        panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            s = new Socket("127.0.0.1", 6001);  // Make sure the server is running on this address and port
